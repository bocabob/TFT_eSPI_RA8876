...
#ifndef _TFT_eSPI_RA8876_H_
#define _TFT_eSPI_RA8876_H_
...
// ============================================================
// Per-project hardware configuration (preferred approach)
// ============================================================
// To avoid editing this library's User_Setup_Select.h, place a
// file named "tft_RA8876_setup.h" in your sketch folder (Arduino
// IDE) or in a directory on the compiler include path (PlatformIO).
// That file must define USER_SETUP_LOADED and all required config
// macros (driver, pins, SPI frequency, etc.).
//
// Example tft_RA8876_setup.h:
//   #pragma once
...
//
// PlatformIO alternative: place tft_RA8876_setup.h anywhere and
// add its directory to build_flags:
//   build_flags = -I src/config
//
// If no tft_RA8876_setup.h is found the library falls back to
// User_Setup_Select.h inside the library folder.
// ============================================================
  ...
  #endif
#else
  #if __has_include(<tft_RA8876_setup.h>)
    #include <tft_RA8876_setup.h>
...
class TFT_eSPI_RA8876 : public Print { friend class TFT_eSprite_RA8876; // Sprite class has access to protected members

 //--------------------------------------- public ------------------------------------//
 public:

  TFT_eSPI_RA8876(int16_t _W = TFT_WIDTH, int16_t _H = TFT_HEIGHT);
  ...
  // The TFT_eSprite_RA8876 class inherits the following functions (not all are useful to Sprite class
...
#else
    #if !defined(DISABLE_ALL_LIBRARY_WARNINGS)
      #warning >>>>------>> TOUCH_CS pin not defined, TFT_eSPI_RA8876 touch functions will not be available!
    #endif
#endif
...
#endif // ends #ifndef _TFT_eSPI_RA8876_H_
