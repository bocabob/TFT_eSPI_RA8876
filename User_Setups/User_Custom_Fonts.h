...
// Custom "Adafruit" compatible font files can be added to the "TFT_eSPI_RA8876/Fonts/Custom" folder
...
// When font files are placed in the Custom folder (TFT_eSPI_RA8876\Fonts\Custom) then they must
