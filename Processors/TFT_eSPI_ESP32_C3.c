        ...
        ////////////////////////////////////////////////////
        // TFT_eSPI_RA8876 driver functions for ESP32 processors //
        ////////////////////////////////////////////////////
...
***************************************************************************************/
void TFT_eSPI_RA8876::begin_SDA_Read(void)
{
...
***************************************************************************************/
void TFT_eSPI_RA8876::end_SDA_Read(void)
{
...
uint8_t TFT_eSPI_RA8876::readByte(void)
{
  uint8_t b = 0xAA;
...
***************************************************************************************/
void TFT_eSPI_RA8876::busDir(uint32_t mask, uint8_t mode)
{
...
***************************************************************************************/
void TFT_eSPI_RA8876::gpioMode(uint8_t gpio, uint8_t mode)
{
  pinMode(gpio, mode);
...
***************************************************************************************/
void TFT_eSPI_RA8876::pushSwapBytePixels(const void* data_in, uint32_t len){
...
***************************************************************************************/
bool TFT_eSPI_RA8876::dmaBusy(void)
{
...
***************************************************************************************/
void TFT_eSPI_RA8876::dmaWait(void)
{
...
void TFT_eSPI_RA8876::pushPixelsDMA(uint16_t* image, uint32_t len)
{
...
void TFT_eSPI_RA8876::pushImageDMA(int32_t x, int32_t y, int32_t w, int32_t h, uint16_t const* image)
{
...
void TFT_eSPI_RA8876::pushImageDMA(int32_t x, int32_t y, int32_t w, int32_t h, uint16_t* image, uint16_t* buffer)
{
...
***************************************************************************************/
bool TFT_eSPI_RA8876::initDMA(bool ctrl_cs)
{
...
***************************************************************************************/
void TFT_eSPI_RA8876::deInitDMA(void)
{
