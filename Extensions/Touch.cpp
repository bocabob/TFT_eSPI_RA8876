...
inline void TFT_eSPI_RA8876::begin_touch_read_write(void){
  DMA_BUSY_CHECK;
...
***************************************************************************************/
inline void TFT_eSPI_RA8876::end_touch_read_write(void){
  T_CS_H;
  #if defined (SPI_HAS_TRANSACTION) && defined (SUPPORT_TRANSACTIONS)
...
***************************************************************************************/
void TFT_eSPI_RA8876::spi_begin_touch() {begin_touch_read_write();}
void TFT_eSPI_RA8876::spi_end_touch()   {  end_touch_read_write();}

/***************************************************************************************
** Function name:           getTouchRaw
** Description:             read raw touch position.  Always returns true.
***************************************************************************************/
uint8_t TFT_eSPI_RA8876::getTouchRaw(uint16_t *x, uint16_t *y){
  uint16_t tmp;
...
***************************************************************************************/
uint16_t TFT_eSPI_RA8876::getTouchRawZ(void){
...
uint8_t TFT_eSPI_RA8876::validTouch(uint16_t *x, uint16_t *y, uint16_t threshold){
...
***************************************************************************************/
uint8_t TFT_eSPI_RA8876::getTouch(uint16_t *x, uint16_t *y, uint16_t threshold){
...
***************************************************************************************/
void TFT_eSPI_RA8876::convertRawXY(uint16_t *x, uint16_t *y)
{
...
***************************************************************************************/
void TFT_eSPI_RA8876::calibrateTouch(uint16_t *parameters, uint32_t color_fg, uint32_t color_bg, uint8_t size){
...
***************************************************************************************/
void TFT_eSPI_RA8876::setTouch(uint16_t *parameters){
