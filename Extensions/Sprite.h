...
class TFT_eSprite_RA8876 : public TFT_eSPI_RA8876 {

 public:

  explicit TFT_eSprite_RA8876(TFT_eSPI_RA8876 *tft);
  ~TFT_eSprite_RA8876(void);
  ...
  bool     pushRotated(TFT_eSprite_RA8876 *spr, int16_t angle, uint32_t transp = 0x00FFFFFF);
  ...
  bool     getRotatedBounds(TFT_eSprite_RA8876 *spr, int16_t angle, int16_t *min_x, int16_t *min_y,
  ...
  bool     pushToSprite(TFT_eSprite_RA8876 *dspr, int32_t x, int32_t y);
  bool     pushToSprite(TFT_eSprite_RA8876 *dspr, int32_t x, int32_t y, uint16_t transparent);
