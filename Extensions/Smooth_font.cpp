 ...
 // This is part of the TFT_eSPI_RA8876 class and is associated with anti-aliased font functions
...
*************************************************************************************x*/
void TFT_eSPI_RA8876::loadFont(const uint8_t array[])
{
...
*************************************************************************************x*/
void TFT_eSPI_RA8876::loadFont(String fontName, fs::FS &ffs)
{
  fontFS = ffs;
...
** Description:             loads parameters from a font vlw file
*************************************************************************************x*/
void TFT_eSPI_RA8876::loadFont(String fontName, bool flash)
{
  /*
...
void TFT_eSPI_RA8876::loadMetrics(void)
{
...
*************************************************************************************x*/
void TFT_eSPI_RA8876::unloadFont( void )
{
  if (gUnicode)
  {
    free(gUnicode);
...
*************************************************************************************x*/
uint32_t TFT_eSPI_RA8876::readInt32(void)
{
  uint32_t val = 0;
...
*************************************************************************************x*/
bool TFT_eSPI_RA8876::getUnicodeIndex(uint16_t unicode, uint16_t *index)
{
...
void TFT_eSPI_RA8876::drawGlyph(uint16_t code)
{
...
*************************************************************************************x*/
void TFT_eSPI_RA8876::showFont(uint32_t td)
{
