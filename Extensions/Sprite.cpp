...
// from the TFT_eSPI_RA8876 class. Some functions are overridden by this class so that the
...
/***************************************************************************************
** Function name:           TFT_eSprite_RA8876
** Description:             Class constructor
***************************************************************************************/
TFT_eSprite_RA8876::TFT_eSprite_RA8876(TFT_eSPI_RA8876 *tft)
{
...
void* TFT_eSprite_RA8876::createSprite(int16_t w, int16_t h, uint8_t frames)
{
...
***************************************************************************************/
void* TFT_eSprite_RA8876::getPointer(void)
{
...
***************************************************************************************/
bool TFT_eSprite_RA8876::created(void)
{
  return _created;
}
...
***************************************************************************************/
TFT_eSprite_RA8876::~TFT_eSprite_RA8876(void)
{
  deleteSprite();
...
***************************************************************************************/
void* TFT_eSprite_RA8876::callocSprite(int16_t w, int16_t h, uint8_t frames)
{
...
***************************************************************************************/
void TFT_eSprite_RA8876::createPalette(uint16_t colorMap[], uint8_t colors)
{
  if (!_created) return;
...
** Description:             Set a palette for a 4-bit per pixel sprite
***************************************************************************************/
void TFT_eSprite_RA8876::createPalette(const uint16_t colorMap[], uint8_t colors)
{
  if (!_created) return;
...
void* TFT_eSprite_RA8876::frameBuffer(int8_t f)
{
  if (!_created) return nullptr;
...
***************************************************************************************/
void* TFT_eSprite_RA8876::setColorDepth(int8_t b)
{
...
***************************************************************************************/
int8_t TFT_eSprite_RA8876::getColorDepth(void)
{
...
***************************************************************************************/
void TFT_eSprite_RA8876::setBitmapColor(uint16_t c, uint16_t b)
{
  if (c == b) b = ~c;
  _tft->bitmap_fg = c;
  _tft->bitmap_bg = b;
...
***************************************************************************************/
void TFT_eSprite_RA8876::setPaletteColor(uint8_t index, uint16_t color)
{
...
***************************************************************************************/
uint16_t TFT_eSprite_RA8876::getPaletteColor(uint8_t index)
{
...
***************************************************************************************/
void TFT_eSprite_RA8876::deleteSprite(void)
{
  ...
  if (_created)
  {
    ...
    _img8 = nullptr;
    _created = false;
    _vpOoB   = true;  // TFT_eSPI_RA8876 class write() uses this to check for valid sprite
  }
}
...
***************************************************************************************/
#define FP_SCALE 10
bool TFT_eSprite_RA8876::pushRotated(int16_t angle, uint32_t transp)
{
...
bool TFT_eSprite_RA8876::pushRotated(TFT_eSprite_RA8876 *spr, int16_t angle, uint32_t transp)
{
...
***************************************************************************************/
bool TFT_eSprite_RA8876::getRotatedBounds(int16_t angle, int16_t *min_x, int16_t *min_y,
...
***************************************************************************************/
bool TFT_eSprite_RA8876::getRotatedBounds(TFT_eSprite_RA8876 *spr, int16_t angle, int16_t *min_x, int16_t *min_y,
                                                                    int16_t *max_x, int16_t *max_y)
{
  // Get the bounding box of this rotated source Sprite relative to Sprite pivot
  getRotatedBounds(angle, width(), height(), _xPivot, _yPivot, min_x, min_y, max_x, max_y);
...
***************************************************************************************/
void TFT_eSprite_RA8876::getRotatedBounds(int16_t angle, int16_t w, int16_t h, int16_t xp, int16_t yp,
...
***************************************************************************************/
void TFT_eSprite_RA8876::pushSprite(int32_t x, int32_t y)
{
  if (!_created) return;
...
***************************************************************************************/
void TFT_eSprite_RA8876::pushSprite(int32_t x, int32_t y, uint16_t transp)
{
  if (!_created) return;
...
bool TFT_eSprite_RA8876::pushToSprite(TFT_eSprite_RA8876 *dspr, int32_t x, int32_t y)
{
...
bool TFT_eSprite_RA8876::pushToSprite(TFT_eSprite_RA8876 *dspr, int32_t x, int32_t y, uint16_t transp)
{
...
***************************************************************************************/
bool TFT_eSprite_RA8876::pushSprite(int32_t tx, int32_t ty, int32_t sx, int32_t sy, int32_t sw, int32_t sh)
{
  if (!_created) return false;
...
***************************************************************************************/
uint16_t TFT_eSprite_RA8876::readPixelValue(int32_t x, int32_t y)
{
...
***************************************************************************************/
uint16_t TFT_eSprite_RA8876::readPixel(int32_t x, int32_t y)
{
...
***************************************************************************************/
void  TFT_eSprite_RA8876::pushImage(int32_t x, int32_t y, int32_t w, int32_t h, uint16_t *data, uint8_t sbpp)
{
...
***************************************************************************************/
void  TFT_eSprite_RA8876::pushImage(int32_t x, int32_t y, int32_t w, int32_t h, const uint16_t *data)
{
#ifdef ESP32
  ...
  else if (_bpp == 4)
  {
    ...
    Serial.println("TFT_eSprite_RA8876::pushImage(int32_t x, int32_t y, int32_t w, int32_t h, const uint16_t *data) not implemented");
    #endif
    return;
  }
...
void TFT_eSprite_RA8876::setWindow(int32_t x0, int32_t y0, int32_t x1, int32_t y1)
{
...
***************************************************************************************/
void TFT_eSprite_RA8876::pushColor(uint16_t color)
{
  if (!_created ) return;
...
***************************************************************************************/
void TFT_eSprite_RA8876::pushColor(uint16_t color, uint32_t len)
{
  if (!_created ) return;
...
***************************************************************************************/
void TFT_eSprite_RA8876::writeColor(uint16_t color)
{
  if (!_created ) return;
...
void TFT_eSprite_RA8876::setScrollRect(int32_t x, int32_t y, int32_t w, int32_t h, uint16_t color)
{
...
***************************************************************************************/
void TFT_eSprite_RA8876::scroll(int16_t dx, int16_t dy)
{
...
***************************************************************************************/
void TFT_eSprite_RA8876::fillSprite(uint32_t color)
{
...
int16_t TFT_eSprite_RA8876::width(void)
{
...
***************************************************************************************/
int16_t TFT_eSprite_RA8876::height(void)
{
  if (!_created ) return 0;
...
void TFT_eSprite_RA8876::setRotation(uint8_t r)
{
  if (_bpp != 1) return;
...
***************************************************************************************/
uint8_t TFT_eSprite_RA8876::getRotation(void)
{
  return rotation;
}
...
***************************************************************************************/
void TFT_eSprite_RA8876::drawPixel(int32_t x, int32_t y, uint32_t color)
{
  if (!_created || _vpOoB) return;
...
***************************************************************************************/
void TFT_eSprite_RA8876::drawLine(int32_t x0, int32_t y0, int32_t x1, int32_t y1, uint32_t color)
{
  if (!_created || _vpOoB) return;
...
***************************************************************************************/
void TFT_eSprite_RA8876::drawFastVLine(int32_t x, int32_t y, int32_t h, uint32_t color)
{
  if (!_created || _vpOoB) return;
...
***************************************************************************************/
void TFT_eSprite_RA8876::drawFastHLine(int32_t x, int32_t y, int32_t w, uint32_t color)
{
  if (!_created || _vpOoB) return;
...
***************************************************************************************/
void TFT_eSprite_RA8876::fillRect(int32_t x, int32_t y, int32_t w, int32_t h, uint32_t color)
{
  if (!_created || _vpOoB) return;
...
***************************************************************************************/
void TFT_eSprite_RA8876::drawChar(int32_t x, int32_t y, uint16_t c, uint32_t color, uint32_t bg, uint8_t size)
{
...
***************************************************************************************/
  // TODO: Rationalise with TFT_eSPI_RA8876
  // Any UTF-8 decoding must be done before calling drawChar()
int16_t TFT_eSprite_RA8876::drawChar(uint16_t uniCode, int32_t x, int32_t y)
{
  return drawChar(uniCode, x, y, textfont);
}

  // Any UTF-8 decoding must be done before calling drawChar()
int16_t TFT_eSprite_RA8876::drawChar(uint16_t uniCode, int32_t x, int32_t y, uint8_t font)
{
...
***************************************************************************************/
//
void TFT_eSprite_RA8876::drawGlyph(uint16_t code)
{
...
***************************************************************************************/
void TFT_eSprite_RA8876::printToSprite(String string)
{
...
** Description:             Write a string to the sprite cursor position
***************************************************************************************/
void TFT_eSprite_RA8876::printToSprite(char *cbuffer, uint16_t len) //String string)
{
  if(!fontLoaded) return;
...
***************************************************************************************/
int16_t TFT_eSprite_RA8876::printToSprite(int16_t x, int16_t y, uint16_t index)
{
  bool newSprite = !_created;
