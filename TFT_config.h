...
/***************************************************************************************
**                         TFT_eSPI_RA8876 Configuration defines
***************************************************************************************/
// Override defaults
...
// General pins
#if CONFIG_TFT_CS == -1
    #error "Invalid Chip Select pin. Check TFT_eSPI_RA8876 configuration"
#else
    #define TFT_CS          CONFIG_TFT_CS
#endif

#if CONFIG_TFT_DC == -1
    #error "Invalid Data/Command pin. Check TFT_eSPI_RA8876 configuration"
#else
    #define TFT_DC          CONFIG_TFT_DC
        ...
        #warning "Invalid Reset pin. Check TFT_eSPI_RA8876 configuration"
    #endif
#else
...
// Backlight config
    ...
    #if CONFIG_TFT_BL == -1
        #error "Invalid backlight control pin. Check TFT_eSPI_RA8876 configuration"
    #else
...
// 8 BIT PARALLEL BUS
    ...
    #if CONFIG_TFT_D0 == -1
        #error "Invalid Data 0 pin. Check TFT_eSPI_RA8876 configuration"
    #else
        #define TFT_D0      CONFIG_TFT_D0
    #endif

    #if CONFIG_TFT_D1 == -1
        #error "Invalid Data 1 pin. Check TFT_eSPI_RA8876 configuration"
    #else
        #define TFT_D1      CONFIG_TFT_D1
    #endif

    #if CONFIG_TFT_D2 == -1
        #error "Invalid Data 2 pin. Check TFT_eSPI_RA8876 configuration"
    #else
        #define TFT_D2      CONFIG_TFT_D2
    #endif

    #if CONFIG_TFT_D3 == -1
        #error "Invalid Data 3 pin. Check TFT_eSPI_RA8876 configuration"
    #else
        #define TFT_D3      CONFIG_TFT_D3
    #endif

    #if CONFIG_TFT_D4 == -1
        #error "Invalid Data 4 pin. Check TFT_eSPI_RA8876 configuration"
    #else
        #define TFT_D4      CONFIG_TFT_D4
    #endif

    #if CONFIG_TFT_D5 == -1
        #error "Invalid Data 5 pin. Check TFT_eSPI_RA8876 configuration"
    #else
        #define TFT_D5      CONFIG_TFT_D5
    #endif

    #if CONFIG_TFT_D6 == -1
        #error "Invalid Data 6 pin. Check TFT_eSPI_RA8876 configuration"
    #else
        #define TFT_D6      CONFIG_TFT_D6
    #endif

    #if CONFIG_TFT_D7 == -1
        #error "Invalid Data 7 pin. Check TFT_eSPI_RA8876 configuration"
    #else
        #define TFT_D7      CONFIG_TFT_D7
    #endif
    
    #if CONFIG_TFT_WR == -1
        #error "Invalid Write strobe pin. Check TFT_eSPI_RA8876 configuration"
    #else
        #define TFT_WR      CONFIG_TFT_WR
    #endif

    #if CONFIG_TFT_RD == -1
        #error "Invalid Read strobe pin. Check TFT_eSPI_RA8876 configuration"
    #else
...
// SPI BUS
        ...
        #error "Invalid MOSI pin. Check TFT_eSPI_RA8876 configuration"
    #else
        #define TFT_MOSI      CONFIG_TFT_MOSI
    #endif

    #if CONFIG_TFT_SCLK == -1
        #error "Invalid Clock pin. Check TFT_eSPI_RA8876 configuration"
    #else
...
***************************************************************************************/
        ...
        #error "Invalid Touch Chip Select pin. Check TFT_eSPI_RA8876 configuration"
    #else
